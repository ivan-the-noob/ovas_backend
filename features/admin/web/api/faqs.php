        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../../function/php/save_faqs.php" method="POST" enctype="multipart/form-data">
                        <!-- Removed the category_name input field -->
                        <div class="form-group">
                            <label for="faqImage">FAQ Image (optional)</label>
                            <input type="file" class="form-control mt-2" id="faqImage" name="faq_image">
                        </div>
                </div>
            ...
            try {
                ...
                if ($faqs) {
                    foreach ($faqs as $row) {
                        ...
                        if ($row['image']) {
                            echo '<td><img src="../../../../assets/img/faqs/' . htmlspecialchars($row['image']) . '" alt="FAQ Image" style="width: 50px; height: 50px;"></td>';
                        } else {
                            echo '<td>No image</td>';
                        }
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="../../function/php/delete_faq.php?id=' . $row['id'] . '" class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>';
