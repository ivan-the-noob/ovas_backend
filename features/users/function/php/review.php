...
if (count($reviews) > 0) {
    ...
    <div id="reviewCarousel" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                <div class="testimonial-card-custom p-3 review-box">
                                    <div class="d-flex align-items-center mx-auto justify-content-center">
                                        ...
                                        <div class="ml-3 d-flex flex-column gap-2 align-items-center justify-content-center">
                                            ...
                                            <p class="testimonial-rating mb-0 mt-0">
                                                <?php for ($i = 1; $i <= 5; $i++) {
                                                    echo $i <= $chunk[0]['rating'] ? '<i class="fa fa-star" style="color: gold; font-size: 30px;"></i>' : '<i class="fa fa-star-o"></i>';
                                                } ?>
                                            </p>
                                    ...
                                    <div class="d-flex gap-1 w-100">
                                        <p class="w-50 p-4"><?php echo nl2br(htmlspecialchars($chunk[0]['comment'], ENT_QUOTES, 'UTF-8')); ?></p>
                                        <?php if (isset($chunk[0]['image']) && $chunk[0]['image']) { ?>
                                            <img src="assets/img/review/<?php echo htmlspecialchars($chunk[0]['image'], ENT_QUOTES, 'UTF-8'); ?>" alt="Review Image" class="img-fluid comment-img w-50">
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="testimonial-card-custom p-3 review-box">
                                    <div class="d-flex align-items-center mx-auto justify-content-center">
                                        ...
                                        <div class="ml-3 d-flex flex-column gap-2 align-items-center justify-content-center">
                                            ...
                                            <p class="testimonial-rating mb-0 mt-0">
                                                <?php for ($i = 1; $i <= 5; $i++) {
                                                    echo $i <= $chunk[1]['rating'] ? '<i class="fa fa-star" style="color: gold; font-size: 30px;"></i>' : '<i class="fa fa-star-o"></i>';
                                                } ?>
                                            </p>
                                    ...
                                    <div class="d-flex gap-1 w-100">
                                        <p class="w-50 p-4"><?php echo nl2br(htmlspecialchars($chunk[1]['comment'], ENT_QUOTES, 'UTF-8')); ?></p>
                                        <?php if (isset($chunk[1]['image']) && $chunk[1]['image']) { ?>
                                            <img src="assets/img/review/<?php echo htmlspecialchars($chunk[1]['image'], ENT_QUOTES, 'UTF-8'); ?>" alt="Review Image" class="img-fluid comment-img w-50">
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="testimonial-card-custom p-3 review-box">
                                    <div class="d-flex align-items-center mx-auto justify-content-center">
                                        ...
                                        <div class="ml-3 d-flex flex-column gap-2 align-items-center justify-content-center">
                                            ...
                                            <p class="testimonial-rating mb-0 mt-0">
                                                <?php for ($i = 1; $i <= 5; $i++) {
                                                    echo $i <= $chunk[2]['rating'] ? '<i class="fa fa-star" style="color: gold; font-size: 30px;"></i>' : '<i class="fa fa-star-o"></i>';
                                                } ?>
                                            </p>
                                    ...
                                    <div class="d-flex gap-1 w-100">
                                        <p class="w-50 p-4"><?php echo nl2br(htmlspecialchars($chunk[2]['comment'], ENT_QUOTES, 'UTF-8')); ?></p>
                                        <?php if (isset($chunk[2]['image']) && $chunk[2]['image']) { ?>
                                            <img src="assets/img/review/<?php echo htmlspecialchars($chunk[2]['image'], ENT_QUOTES, 'UTF-8'); ?>" alt="Review Image" class="img-fluid comment-img w-50">
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="testimonial-card-custom p-3 review-box">
                                    <div class="d-flex align-items-center mx-auto justify-content-center">
                                        ...
                                        <div class="ml-3 d-flex flex-column gap-2 align-items-center justify-content-center">
                                            ...
                                            <p class="testimonial-rating mb-0 mt-0">
                                                <?php for ($i = 1; $i <= 5; $i++) {
                                                    echo $i <= $chunk[3]['rating'] ? '<i class="fa fa-star" style="color: gold; font-size: 30px;"></i>' : '<i class="fa fa-star-o"></i>';
                                                } ?>
                                            </p>
                                    ...
                                    <div class="d-flex gap-1 w-100">
                                        <p class="w-50 p-4"><?php echo nl2br(htmlspecialchars($chunk[3]['comment'], ENT_QUOTES, 'UTF-8')); ?></p>
                                        <?php if (isset($chunk[3]['image']) && $chunk[3]['image']) { ?>
                                            <img src="assets/img/review/<?php echo htmlspecialchars($chunk[3]['image'], ENT_QUOTES, 'UTF-8'); ?>" alt="Review Image" class="img-fluid comment-img w-50">
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
        ...
        <!-- Carousel controls -->
        <button class="carousel-control-prev custom-carousel-control" type="button" data-bs-target="#reviewCarousel" data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
    </button>
    <button class="carousel-control-next custom-carousel-control" type="button" data-bs-target="#reviewCarousel" data-bs-slide="next">
